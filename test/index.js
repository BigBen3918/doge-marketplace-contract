...
describe("deploy contract", function () {
  ...
  it("nft contracts", async function () {
    ...
    NFT2 = await Factory.deploy("test2NFT", "t2NFT");
    await NFT2.deployed();
  });
...
describe("normal test contract", function () {
  it("mint nft", async function () {
    var tx = await NFT1.mint("QmShtKZfFZfQPiVoh3DBipgrYes21VpKckmePe8iA1nnjB");
    await tx.wait();
    tx = await NFT1.mint("QmShtKZfFZfQPiVoh3DBipgrYes21VpKckmePe8iA1nnjB");
    await tx.wait();
    tx = await NFT1.mint("QmShtKZfFZfQPiVoh3DBipgrYes21VpKckmePe8iA1nnjB");
    await tx.wait();
    tx = await NFT1.mint("QmShtKZfFZfQPiVoh3DBipgrYes21VpKckmePe8iA1nnjB");
  ...
  it("check interface", async function () {
    let isValid = await NFT1.supportsInterface("0x780e9d63");
    console.log("isValid", isValid);
  })
});
>>>>>>> eb104999ced377a2f743aebe1614ff070221cec9:test/index.js_
